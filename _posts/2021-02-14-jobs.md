...
Job searching during Brexit and a pandemic is a nothing less than a nightmare. Hundreds of applications later and you wonder if they got sent straight to the void.

In order to make this process easier for myself I decided to automate the process. The first step was to find a bulk list of company emails. CrunchBase is great for this. With a free trial they allow you to search for a list of companies against filters like date founded, number of employees etc.
...
This is as far as I've got so far. When my email campaign is completed I'll be sure to upadte this post.
