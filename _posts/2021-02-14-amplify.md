...
Here I'll outline the steps needed to setup a website like this one. However, this is just the initial setup. In order to add your own blog posts, contact details etc. you'll have to play around with the code some more.
...
First step is to go shopping for what Jekyll theme you want to use. This is the fun part. There are plenty of websites that list themes but the one I like is [jekyllthemes.org](http://jekyllthemes.org/), as pictured below.
